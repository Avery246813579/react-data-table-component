...
var TableCellCheckboxStyle = styled__default['default'](CellBase)(_templateObject$6(), function (_ref) {
  var footer = _ref.footer;
  return footer ? 'hidden' : 'visible';
});

var TableCellCheckbox = function TableCellCheckbox(_ref2) {
  var name = _ref2.name,
      row = _ref2.row,
...
var TableCellExpanderStyle = styled__default['default'](CellBase)(_templateObject$8(), function (_ref) {
  var footer = _ref.footer;
  return footer ? 'hidden' : 'visible';
}, function (props) {
...
var TableCellExpander = function TableCellExpander(_ref2) {
  var column = _ref2.column,
      row = _ref2.row,
      expanded = _ref2.expanded,
      onRowExpandToggled = _ref2.onRowExpandToggled,
...
var DataTable = /*#__PURE__*/React.memo(function (_ref) {
  ...
  }), footer && /*#__PURE__*/React__default['default'].createElement(TableRow, {
    id: -1,
    rowIndex: -1,
    keyField: keyField,
    row: footerBold ? Object.keys(footer).reduce(function (dict, key) {
      // eslint-disable-next-line no-param-reassign
      dict[key] = /*#__PURE__*/React__default['default'].createElement("b", null, footer[key]);
      return dict;
    }, {}) : footer,
    columns: columnsMemo,
    selectableRows: selectableRows,
